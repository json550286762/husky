...
public final class orderList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t{field:'orderId',title:'订单Id',sortable:true,width:60},\r\n");
      out.write("        {field:'orderNo',title:'订单号',sortable:true,width:60},    \r\n");
      out.write("\t\t{field:'itemCode',title:'产品编号',sortable:true,width:60},\r\n");
      out.write("        {field:'buyerId',title:'买家Id',sortable:true},\r\n");
      out.write("        {field:'buyerNickName',title:'买家别名',sortable:true,width:100},\r\n");
      out.write("        {field:'orderStatus',title:'订单状态',sortable:true},\r\n");
      out.write("        {field:'orderDate',title:'下单时间',sortable:true},\r\n");
      out.write("        {field:'createTime',title:'创建时间',sortable:true},\r\n");
      out.write("        {field:'createId',title:'创建人',sortable:true},\r\n");
      out.write("        {field:'lastUpdateId',title:'最后更新人',sortable:true},\r\n");
      out.write("        {field:'lastUpdateTime',title:'最后更新时间',sortable:true}\r\n");
      out.write("    ]],\r\n");
      ...
      out.write("    \t$('.datagrid-btable').find('.datagrid-header .datagrid-cell').css('text-align','center');\r\n");
      out.write("    \t//$('.datagrid-btable').find('div.datagrid-cell').css('text-align','center');\r\n");
      out.write("    }\r\n");
      out.write("});\r\n");
      out.write("});\r\n");
      out.write("\r\n");
  ...
  private boolean _jspx_meth_shiro_hasPermission_0(PageContext _jspx_page_context)
    ...
    _jspx_th_shiro_hasPermission_0.setName("sys:dict:delete");
  ...
  private boolean _jspx_meth_shiro_hasPermission_1(PageContext _jspx_page_context)
    ...
    _jspx_th_shiro_hasPermission_1.setName("sys:dict:update");
